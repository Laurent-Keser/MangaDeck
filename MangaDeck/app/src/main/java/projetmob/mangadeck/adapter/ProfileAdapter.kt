...
import projetmob.mangadeck.databinding.ProfileRatingBinding
import projetmob.mangadeck.model.ReviewProperty

/**
 * adapter pour le recyclerview de profil
 */
class ProfileAdapter (query: Query, private val onClickListener: OnClickListener) :
    FirestoreAdapter<ProfileAdapter.DetailPropertyViewHolder>(query) {

    class DetailPropertyViewHolder(private var binding: ProfileRatingBinding) :
    ...
    override fun onCreateViewHolder(
        ...
        return DetailPropertyViewHolder(ProfileRatingBinding.inflate(LayoutInflater.from(parent.context)))
    }
